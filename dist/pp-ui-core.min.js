...
function initDatepicker() {
  document.querySelectorAll("[data-pp-datepicker]").forEach(input => {
    ...
    input.min = `${yyyy}-${mm}-${dd}`;
     ...
     /* =========================
       STYLES (FROM DEFAULTS ONLY) - allow instance overrides
     ========================= */
...
initToastForms();function submitAddressForm(formId) {
  const form = document.getElementById(formId);
  if (!form) {
    alert("Form not found: " + formId);
    return;
...
window.submitAddressForm = submitAddressForm;function submitPPForm(formId, title = "Form Data") {
  const form = document.getElementById(formId);
  if (!form) {
    alert("Form not found: " + formId);
    return;
